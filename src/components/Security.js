  ...
  return (
    <div className="container">
      <div className="container-fluid p-10">
        ...
        {/* content */}
        <h5>
          <strong>Nagpur's Top Security Services</strong>
        </h5>
        <div style={{ padding: "2px" }}></div>
        {/* client-1 */}
        <div style={{ padding: "2px" }}></div>
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              <h5 className="bp mt-1">
                <b>New Singh Intelligence Service Security Service</b>
              </h5>
              <p>
                Plot No. 65A Niwara Society, Gorewada Rd, Utthan Nagar, Nagpur,
                Maharashtra 440013
              </p>
              <p>
                Security Services, Security Services For Guard, Security
                Services For Office, Security Services For Company, Women
                Security Guard Services, Security Service Personnel Armed Guard,
                Security Services For Residence, Security Guard Services For
                College
              </p>
              <i
