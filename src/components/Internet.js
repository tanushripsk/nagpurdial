...
const whatsappContacts = [
  { id: 1, phone: "918530300808", text1: "Eroth NetLink Solution India Pvt Ltd" },
];
function Internet() {
  ...
  return (
    <div class="container">
      <div class="container-fluid p-10">
        ...
        <h5>
          <strong>Nagpur's Top Internet Services</strong>
        </h5>
        <div style={{ padding: "2px" }}></div>
        {/* <!-- client-1 --> */}
        <div style={{ padding: "2px" }}></div>
        <div class="beauty">
          <div class="row">
            ...
            <div class="col-lg-8">
              <h5 class="bp mt-1">
                <b>Eroth NetLink Solution India Pvt Ltd</b>
              </h5>
              <p class="bp1">
                Shop no.3, Madhuvatsalya Apart -ment, Tukdoji Square, Manewada
                Rd, opposite MSEB Office, Nagpur, Maharashtra 440024
              </p>

              <p class="bp2" style={{ color: "grey" }}>
                Corporate Bandwidth,Data Centre Service,Network
                Service,Hosting,IT System Integration,Smart City Solutions
              </p>
              <i
                class="fa fa-star"
