...
const whatsappContacts1 = [
  { id: 2, phone: "917774036350", text2: "Simi Electronics" },
];
const whatsappContacts2 = [
  { id: 3, phone: "917020959344 ", text3: "ICDI MULTITRADE" },
];
const whatsappContacts3 = [
  { id: 4, phone: "9198225 61120", text4: "Electronic Control Enterprises" },
];
const whatsappContacts4 = [
  { id: 5, phone: "917122461642", text5: "Supertron Electronics Pvt Ltd" },
];
const whatsappContacts5 = [
  { id: 6, phone: "919975288300", text6: "Nagpurdial" },
];
const whatsappContacts6 = [
  { id: 7, phone: "919860990934", text7: "Servetech Electronics Pvt. Ltd." },
];
const whatsappContacts7 = [
  { id: 8, phone: "919326318448", text8: "VIKALP COMPUTERS" },
];
const whatsappContacts8 = [
  { id: 9, phone: "917387982964", text9: "Rohit AIRCON" },
];
  ...
  return (
    <div className="container">
      <div className="container-fluid p-10">
        ...
        <h5>
          <strong>Nagpur's Top Electronics</strong>
        </h5>
        <div style={{ padding: "2px" }}></div>
        {/* <!-- client-1 --> */}
        <div style={{ padding: "2px" }}></div>
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              <h5 className="bp mt-1">
                <b>Bhagwan Gas Pipe Line Fitting</b>
              </h5>
              <p>
                Behind Panchpaoli Police Station, Jhenda Chowk, Kunhadkar Peth,
                Lashishbagh, Nagpur-17
              </p>

              <p>
                Domestic Underground Gas Pipe Line LPG Chemistry Lab Pipe Line
                and High Pressure Gas Pipe Line Maintenance
              </p>
              <i
        ...
        <div className="beauty">
          <div className="row">
            ...
            <div className="col-lg-8">
              <h5 className="bp mt-1">
                <b>Simi Electronics</b>
              </h5>
              <p>
                HO:4th Floor, Rajkamal Complex, Panchsheel Square, Nagpur -
                440012 BO: S-67, 36, RDA Building, New Rajendra Nagar, Sect. 7,
                Raipur.
              </p>

              <p>
                Batteries/Charges|Inverters | Stabilizers |UPS | Diseal Genset |
                Industrial A.C
              </p>
              <i
                className="fa fa-star"
        ...
        <div className="beauty">
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <p>Residential | Commercial | Government | Industrial</p>
              <i
                className="fa fa-star"
                style={{ fontSize: "26px", color: "#FFC300" }}
              ></i>
        ...
        <div className="beauty">
          <div className="row">
            ...
            <div className="col-lg-8">
              <h5 className="bp mt-1">
                <b>Electronic Control Enterprises</b>
              </h5>
              <p>
                Shop No9 Anand Sankul, Hingna Road, Hingna Road, near Raisoni
                School, Nagpur, Maharashtra 440022
              </p>

              <p>Electronic Control Enterprises</p>
              <i
                className="fa fa-star"
                style={{ fontSize: "26px", color: "#FFC300" }}
              ></i>
        ...
        <div className="beauty">
          <div className="row">
            ...
            <div className="col-lg-8">
              <h5 className="bp mt-1">
                <b>Supertron Electronics Pvt Ltd</b>
              </h5>
              <p>
                Plot No. 40, 1st Floor, Sathe Marg, Behind Dhantoli Office,
        ...
        <div className="beauty">
          <div className="row">
            ...
            <div className="col-lg-8">
              <h5 className="bp mt-1">
                <b>Servetech Electronics Pvt. Ltd.</b>
              </h5>
              <p>Plot no. 284 , Nandanvan , Behind - Anand Palace 1 , Nagpur</p>

              <p>
                Belt | Charger | Data Cable | Earphone | Mobile | Power Bank |
                Speaker | Sunglasses | Wallet
              </p>
              <i
                className="fa fa-star"
                style={{ fontSize: "26px", color: "#FFC300" }}
              ...
              {whatsappContacts6.map((contact) => (
                <div key={contact.id7} className="col-lg-4">
                  <div className="container mt-1">
                    <button
                      type="button"
                      className="btn btn-primary"
        ...
        <div className="beauty">
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <p>Laptop Desktop Selling & Repairing</p>
              <i
                className="fa fa-star"
                style={{ fontSize: "26px", color: "#FFC300" }}
              ></i>
        ...
        <div className="beauty">
          <div className="row">
            ...
            <div className="col-lg-8">
              <h5 className="bp mt-1">
                <b>VIKALP COMPUTERS</b>
              </h5>
              <p>
                16, Nilkamal Co-Op. Housing Society Ltd. Indra Nagar, New
                Narsala Road. Nagpur 440034
              </p>

              <p>Computer Repairing and CCTV Installation</p>
              <i
                className="fa fa-star"
                style={{ fontSize: "26px", color: "#FFC300" }}
              ></i>
              ...
              {whatsappContacts7.map((contact) => (
                <div key={contact.id8} className="col-lg-4">
                  <div className="container mt-1">
                    <button
                      type="button"
                      className="btn btn-primary"
        ...
        <div className="beauty">
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <p>Opp. Durga Mandir Jyoti Nagar, Khadan Gandhibag, Nagpur</p>

              <p>
                AC Piping | AC Repair | AC Gas Refilling Fridge | Microwave Oven
                Washing Machine |AC Servicing | AC Installation AC
                Uninstallation
              </p>
              <i
                className="fa fa-star"
              ...
              {whatsappContacts8.map((contact) => (
                <div key={contact.id9} className="col-lg-4">
                  <div className="container mt-1">
                    <button
                      type="button"
                      className="btn btn-primary"
